        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#projects" className="group bg-teal-400 hover:bg-teal-300 text-gray-900 px-8 py-3 rounded-lg font-semibold transition-all duration-300 inline-flex items-center justify-center gap-2">
              ...
              <a href="#contact" className="group border border-teal-400 text-teal-400 hover:bg-teal-400 hover:text-gray-900 px-8 py-3 rounded-lg font-semibold transition-all duration-300 inline-flex items-center justify-center gap-2">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="w-80 h-80 relative">
                ...
                <div className="absolute inset-8 rounded-full overflow-hidden hover:scale-105 transition-transform duration-300">
                  <img 
