...
const Hero = () => {
  return (
    // FIX #1: Increased top padding for mobile (pt-28) and reset it for desktop (lg:pt-20)
    <section id="home" className="min-h-screen bg-gray-900 relative overflow-hidden flex items-center pt-28 lg:pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-32 items-center">
          {/* Left Content */}
          {/* FIX #2: Increased vertical spacing for mobile (space-y-10) and reset it for desktop (lg:space-y-8) */}
