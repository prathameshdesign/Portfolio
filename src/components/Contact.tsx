          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">workpratham907@gmail.com</p>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-12 h-12 bg-gray-800 hover:bg-teal-400 rounded-lg flex items-center justify-center transition-colors group">
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative rounded-2xl p-8" style={{
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Thanks! I'll be in touch soon 🚀</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-teal-400 hover:bg-teal-300 text-gray-900 py-4 rounded-lg font-semibold transition-all duration-300 hover:shadow-[0_0_12px_#2dd4bf88] text-lg"
              >
                Get in touch
              </button>
            </form>
